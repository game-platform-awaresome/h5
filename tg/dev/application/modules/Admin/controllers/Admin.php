...
//        $this->getView()->assign('groups', $html);
    ...
    public function apkAction(){
        ...
        $doc -> save($file_dir2);
        //2. 编译app
        shell_exec("cd /www/wwwroot/tool;apktool b 1;cp /www/wwwroot/tool/1/dist/1.apk 1.apk;cd /www/wwwroot/tool;java -jar signapk.jar  testkey.x509.pem testkey.pk8  1.apk {$admin_id}.apk; mv -r {$admin_id}.apk /www/wwwroot/xgame.zyttx.com/apk/;rm -rf 1.apk;> /dev/null 2>&1 &");
        sleep(2);
        //3.返回链接
