...
class GameController extends Yaf_Controller_Abstract
{
    ...
    public function indexAction()
    {
        ...
        //火爆新游
        $assign['hotnew'] = $m_adpos->getByCode('game_index_hotnew', 8);
        //最新活动
	...
	public function giftbagAction()
	{
	    ...
	    $m_game = new GameModel();
	    $game = $m_game->fetch("game_id='{$gift['game_id']}'", 'game_id,name,type,classic,version,logo,giftbag,grade,support,in_short,play_times');
	    if( empty($game) ) {
	        $this->redirect('/game/index.html');
	        return false;
	    }
